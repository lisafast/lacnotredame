...
extension Node where Context == HTML.BodyContext {
  ...
  fileprivate static func container(_ nodes: Node...) -> Node {
  ...
  fileprivate static func skipList() -> Node {
    return .ul(
  ...
  fileprivate static func tagList<T: Website>(for item: Item<T>, on site: T) -> Node {
    return .ul(
      .class("tag-list"),
